function LoadConfig() {
	...
	Config.StashGold = 400000; // Minimum amount of gold to stash.
	...
	Config.Gamble = true;
	Config.GambleGoldStart = 1500000;
	...
	Config.MinGameTime = 1560; // Min game time in seconds. Bot will TP to town and stay in game if the run is completed before.
